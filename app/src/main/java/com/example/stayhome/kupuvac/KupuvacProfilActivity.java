...
public class KupuvacProfilActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kupuvac_profil);
        ...
        txtSaveEdit = findViewById(R.id.txtKupuvacSaveEdit);
        txtVerify = findViewById(R.id.txtKupuvacNotVerified);
        txtVerified = findViewById(R.id.txtKupuvacVerified);
        editIme = findViewById(R.id.editTextKupuvacIme);
        editTelefon = findViewById(R.id.editTextKupuvacTelefon);
        editEmail = findViewById(R.id.editTextKupuvacEmail);
            ...
            case R.id.action_signout:
                ...
                builder.setPositiveButton(Html.fromHtml("<font color='#FFFFFF'>Да</font>"), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        startActivity(new Intent(KupuvacProfilActivity.this, MainActivity.class));
                        dialog.dismiss();
                    }
                });
    ...
    private void PostaviProfil() {
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(KupuvacProfilActivity.this, "Настана грешка.Обидете се повторно!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void VerifyEmail(View view) {
        ...
        firebaseUser.sendEmailVerification().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                ...
                Toast.makeText(KupuvacProfilActivity.this, "Испратен е линк за верифиакција на вашата е-маил адреса!", Toast.LENGTH_SHORT).show();
            }
    ...
    public void SaveEdit(View view) {
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Toast.makeText(KupuvacProfilActivity.this, "Успешно направивте промена!", Toast.LENGTH_SHORT).show();
            }
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(KupuvacProfilActivity.this, "Настана грешка.Обидете се повторно!", Toast.LENGTH_SHORT).show();
